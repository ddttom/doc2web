  ...
  background-image: ${
    leaderStyle.character === "."
      ? `radial-gradient(circle, currentColor ${
          leaderStyle.spacesBetween <= 2 ? "1px" : "0.8px"
        }, transparent ${leaderStyle.spacesBetween <= 2 ? "1.5px" : "1.2px"})`
      : leaderStyle.character === "-"
      ? "linear-gradient(to right, currentColor 33%, transparent 0%)"
      : leaderStyle.character === "_"
      ? "linear-gradient(to right, currentColor 100%, transparent 0%)"
...
/* Ensure TOC entries without page numbers still maintain layout */
.docx-toc-entry:not(:has(.docx-toc-pagenum:empty)) .docx-toc-dots::after {
  right: 0 !important;
}
`;
